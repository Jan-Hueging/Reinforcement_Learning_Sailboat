...
#ifndef GZ_SIM_SYSTEMS_SAILING_LIFT_DRAG_HH_
#define GZ_SIM_SYSTEMS_SAILING_LIFT_DRAG_HH_
...
namespace systems
{
  ...
  /// - <wind_topic>: Topic, auf dem ein gz.msgs.Vector3d mit der
  ///   Windgeschwindigkeit im Weltkoordinatensystem veröffentlicht wird.
  class SailingLiftDrag
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: SailingLiftDrag();

    /// \brief Destructor
    public: ~SailingLiftDrag() override = default;
    ...
    private: std::unique_ptr<SailingLiftDragPrivate> dataPtr;
  };
  }
}
}
