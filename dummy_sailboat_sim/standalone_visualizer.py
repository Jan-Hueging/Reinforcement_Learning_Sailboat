...
class VisualizerNode(Node):
    ...
    def update_weather(self, _):
        ...
        # Lokal speichern fÃ¼r die Grafik
    ...
    def render_loop(self):
        ...
        # Neues HUD fÃ¼r God-Mode-Schieberegler (darunter)
        ...
        # Fenster schlieÃŸen ermÃ¶glichen (ESC Taste beendet Node)
        key = cv2.waitKey(1)
        if key == 27:
            rclpy.shutdown()
    ...
    def cmd_rudder_cb(self, msg):
        # Aktualisiert Ruder-Anzeige im Radar (EmpfÃ¤ngt jetzt Grad)
        self.current_rudder = math.radians(msg.data)

    def cmd_sail_cb(self, msg):
        # Aktualisiert Segel-Anzeige im Radar (EmpfÃ¤ngt jetzt Grad)
